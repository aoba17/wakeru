...
* [`src/clj/wakeru/`](src/clj/wakeru/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/wakeru/`](src/cljs/wakeru/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/wakeru/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `wakeru` project root directory
...
in the [`src/clj/wakeru/`](src/clj/wakeru/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/wakeru/config.cljs) defaults to `true` in
...
```clj
(ns wakeru.example
  (:require [wakeru.config :as config])
